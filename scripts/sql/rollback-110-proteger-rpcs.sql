-- ROLLBACK da migration 110_proteger_rpcs_authenticated.sql
-- SOMENTE PARA REVISÃO. NÃO EXECUTAR automaticamente.
-- Restaura corpos e GRANTs anteriores à 110.
-- NÃO remove public.is_staff_user() (isso é rollback da 109).
-- NÃO altera policies da 109.

-- =============================================================================
-- 1) Restaurar corpos staff-only (sem barreira RPC_STAFF_ONLY)
-- =============================================================================
...
-- =============================================================================
-- 2) GRANTs anteriores à 110
-- =============================================================================

grant execute on function public.is_admin_user() to public;
grant execute on function public.is_admin_user() to authenticated;

grant execute on function public.aprovar_orcamento_integrar_cliente(uuid, jsonb, jsonb) to public;
grant execute on function public.aprovar_orcamento_integrar_cliente(uuid, jsonb, jsonb) to authenticated;

grant execute on function public.recompute_cliente_disponivel_agendamento(uuid) to public;
grant execute on function public.recompute_cliente_disponivel_agendamento(uuid) to authenticated;

grant execute on function public.assert_cliente_sem_inadimplencia(text) to public;
...
grant execute on function public.gerar_numero_orcamento() to public;

grant execute on function public.backfill_orcamentos_aprovados_clientes() to public;
grant execute on function public.backfill_orcamentos_aprovados_clientes() to authenticated;

grant execute on function public.gerar_numero_contrato() to public;
grant execute on function public.gerar_numero_contrato() to authenticated;

grant execute on function public.contrato_libera_agendamento(uuid, boolean, boolean) to public;
grant execute on function public.contrato_libera_agendamento(uuid, boolean, boolean) to authenticated;
