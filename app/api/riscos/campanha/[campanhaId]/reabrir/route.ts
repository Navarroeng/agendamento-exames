...
import { reabrirCampanhaRiscosNoServidor } from "@/services/riscos-campanha-ciclo.server";
...
export async function POST(
  ...
  try {
    ...
    const campanha = await reabrirCampanhaRiscosNoServidor(
      campanhaId,
    ...
    console.error("[riscos/campanha/reabrir]", err);
    const message =
      err instanceof Error ? err.message : "Não foi possível reabrir a pesquisa.";
    const status =
