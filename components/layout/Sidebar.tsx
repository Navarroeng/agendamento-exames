...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-[5] hidden w-[248px] flex-col border-r border-white/[0.08] bg-[#384393] px-3 py-5 shadow-[4px_0_24px_rgba(56,67,147,0.18)] sidebar:flex">
      ...
      <nav className="flex flex-1 flex-col overflow-y-auto px-0.5 py-0.5">
      ...
      <div className="help-card mt-auto shrink-0 rounded-xl border border-white/[0.08] bg-white/[0.04] p-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] backdrop-blur-md">
        <h3 className="text-[13px] font-semibold text-[#E5E7EB]">
          Gestão ocupacional
        </h3>
        <p className="mt-1 text-[11px] leading-relaxed text-[#94A3B8]">
          Controle ASO, clínicas, exames e faturamento.
        </p>
        <button
          type="button"
          className="mt-3 w-full cursor-pointer rounded-lg border border-white/[0.1] bg-white/[0.05] py-2 text-xs font-semibold text-[#E5E7EB] transition-all duration-200 ease-out hover:border-white/[0.14] hover:bg-white/[0.08] hover:text-white"
        >
          Falar com suporte
        </button>
      </div>
