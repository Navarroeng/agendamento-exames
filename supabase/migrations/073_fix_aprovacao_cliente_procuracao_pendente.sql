-- Corrige RPCs que ainda inseriam clientes.procuracao = 'inativa'
-- (legado). Valores permitidos: pendente | ativa | nao_necessaria.
...
-- Mesma correção no backfill (ainda podia criar cliente com 'inativa').
