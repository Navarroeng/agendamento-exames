-- 124: Aprovação do Laudo AET sem quantidade de colaboradores e sem
-- criar cliente_contratos SST (não encerra contrato ativo nem libera exames).
