-- Ajusta trigger de duplicidade 90 dias: bloqueia somente o mesmo tipo de ASO.
-- Agendamentos cancelados continuam ignorados.
-- Tipos diferentes passam no banco; o frontend exige confirmação.
