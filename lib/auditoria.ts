...
export const AUDITORIA_ACOES = {
  ...
  fatura_envio_email_enviado: "fatura_envio_email_enviado",
  fatura_envio_email_reenviado: "fatura_envio_email_reenviado",
  fatura_envio_email_falhou: "fatura_envio_email_falhou",
  ...
  riscos_campanha_periodo_editado: "riscos_campanha_periodo_editado",
  ...
  implantacao_aet_documento_anexado: "implantacao_aet_documento_anexado",
  implantacao_aet_documento_removido: "implantacao_aet_documento_removido",
  implantacao_aet_visita_agendada: "implantacao_aet_visita_agendada",
  implantacao_aet_visita_realizada: "implantacao_aet_visita_realizada",
  implantacao_aet_elaboracao_iniciada: "implantacao_aet_elaboracao_iniciada",
  implantacao_aet_elaboracao_concluida: "implantacao_aet_elaboracao_concluida",
  implantacao_aet_laudo_anexado: "implantacao_aet_laudo_anexado",
  implantacao_aet_envio_confirmado: "implantacao_aet_envio_confirmado",
...
export const AUDITORIA_ACAO_LABELS: Record<AuditoriaAcao, string> = {
  ...
  fatura_envio_email_enviado: "Fatura enviada por e-mail",
  fatura_envio_email_reenviado: "Fatura reenviada por e-mail",
  fatura_envio_email_falhou: "Falha no envio de fatura por e-mail",
  ...
  riscos_campanha_periodo_editado: "Período da campanha de avaliação editado",
  ...
  riscos_relatorio_envio_confirmado:
  ...
  implantacao_aet_documento_anexado: "Documento da empresa anexado no AET",
  implantacao_aet_documento_removido: "Documento da empresa removido do AET",
  implantacao_aet_visita_agendada: "Visita do AET agendada",
  implantacao_aet_visita_realizada: "Visita do AET realizada",
  implantacao_aet_elaboracao_iniciada: "Elaboração do AET iniciada",
  implantacao_aet_elaboracao_concluida: "Elaboração do AET concluída",
  implantacao_aet_laudo_anexado: "Laudo AET final anexado",
  implantacao_aet_envio_confirmado: "Envio do AET ao cliente confirmado",
